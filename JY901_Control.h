...
unsigned char JY901_SAVECONF[5] = {JY901_CONTROL, JY901_SAVE, 0, 0x00};

unsigned char JY901_SETCALI[5] = {JY901_CONTROL, JY901_CALSW, 0, 0x00};

unsigned char JY901_INSTALL[5] = {JY901_CONTROL, JY901_DIRECTION, 0, 0x00};

const unsigned char JY901_SLEEP[5] = {JY901_CONTROL, JY901_HIBERNATE, 0x01, 0x00};

unsigned char JY901_ALGAXIS[5] = {JY901_CONTROL, JY901_CHANGEALG, 0, 0x00};

unsigned char JY901_GYROAUTO[5] = {JY901_CONTROL, JY901_GYROAUTOCALI, 0, 0x00};

unsigned char JY901_RPTCONF[5] = {JY901_CONTROL, JY901_RSW, 0, 0};

unsigned char JY901_RPTRT[5] = {JY901_CONTROL, JY901_RRATE, 0, 0x00};

unsigned char JY901_BAUDRT[5] = {JY901_CONTROL, JY901_BAUD, 0, 0x00};

unsigned char JY901_AXOFF[5] = {JY901_CONTROL, JY901_AXOFFSET, 0, 0};
unsigned char JY901_AYOFF[5] = {JY901_CONTROL, JY901_AYOFFSET, 0, 0};
unsigned char JY901_AZOFF[5] = {JY901_CONTROL, JY901_AZOFFSET, 0, 0};

unsigned char JY901_GXOFF[5] = {JY901_CONTROL, JY901_GXOFFSET, 0, 0};
unsigned char JY901_GYOFF[5] = {JY901_CONTROL, JY901_GYOFFSET, 0, 0};
unsigned char JY901_GZOFF[5] = {JY901_CONTROL, JY901_GZOFFSET, 0, 0};

unsigned char JY901_HXOFF[5] = {JY901_CONTROL, JY901_HXOFFSET, 0, 0};
unsigned char JY901_HYOFF[5] = {JY901_CONTROL, JY901_HYOFFSET, 0, 0};
unsigned char JY901_HZOFF[5] = {JY901_CONTROL, JY901_HZOFFSET, 0, 0};

unsigned char JY901_D0MODECONF[5] = {JY901_CONTROL, JY901_D0MODE, 0, 0x00};
unsigned char JY901_D1MODECONF[5] = {JY901_CONTROL, JY901_D1MODE, 0, 0x00};
unsigned char JY901_D2MODECONF[5] = {JY901_CONTROL, JY901_D2MODE, 0, 0x00};
unsigned char JY901_D3MODECONF[5] = {JY901_CONTROL, JY901_D3MODE, 0, 0x00};

unsigned char JY901_D0PWMHCONF[5] = {JY901_CONTROL, JY901_D0PWMH, 0, 0};
unsigned char JY901_D1PWMHCONF[5] = {JY901_CONTROL, JY901_D1PWMH, 0, 0};
unsigned char JY901_D2PWMHCONF[5] = {JY901_CONTROL, JY901_D2PWMH, 0, 0};
unsigned char JY901_D3PWMHCONF[5] = {JY901_CONTROL, JY901_D3PWMH, 0, 0};

unsigned char JY901_D0PWMTCONF[5] = {JY901_CONTROL, JY901_D0PWMT, 0, 0};
unsigned char JY901_D1PWMTCONF[5] = {JY901_CONTROL, JY901_D1PWMT, 0, 0};
unsigned char JY901_D2PWMTCONF[5] = {JY901_CONTROL, JY901_D2PWMT, 0, 0};
unsigned char JY901_D3PWMTCONF[5] = {JY901_CONTROL, JY901_D3PWMT, 0, 0};

unsigned char JY901_IICADDRESS[5] = {JY901_CONTROL, JY901_IICADDR, 0, 0x00};

unsigned char JY901_LED[5] = {JY901_CONTROL, JY901_LEDOFF, 0, 0x00};

unsigned char JY901_GPSBAUDRATE[5] = {JY901_CONTROL, JY901_GPSBAUD, 0, 0x00};
